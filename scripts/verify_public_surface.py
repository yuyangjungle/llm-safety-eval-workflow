...
MARKDOWN_FILES = [
    ...
    "llm-safety-eval-workflow/docs/interview_walkthrough.md",
    ...
    "llm-safety-eval-workflow/docs/release_notes_v0.3.0.md",
...
def main() -> None:
    ...
    checks.extend(
        [
            require(package_json.get("version") == "0.3.0", "package_version_0_3_0"),
            ...
            require("llm-safety-eval-workflow/docs/interview_walkthrough.md" in root_readme, "root_readme_demo_walkthrough_link"),
            require("llm-safety-eval-workflow/docs/live_api_eval.md" in root_readme, "root_readme_live_api_link"),
            require("llm-safety-eval-workflow/docs/release_notes_v0.3.0.md" in root_readme, "root_readme_release_notes_link"),
            ...
            require("Real API Path" in root_readme, "root_readme_real_api_path_section"),
            require("Limitations" in root_readme, "root_readme_limitations_section"),
            ...
            require("docs/interview_walkthrough.md" in project_readme, "project_readme_demo_walkthrough_link"),
            ...
            require("docs/release_notes_v0.3.0.md" in project_readme, "project_readme_release_notes_link"),
            ...
            require("Real API Path" in project_readme, "project_readme_real_api_path_section"),
            require("Limitations" in project_readme, "project_readme_limitations_section"),
    ...
    for file in HTML_FILES:
        ...
        checks.extend(
            [
                require("LLM Safety Eval Workflow | AI Data & Safety Demo" in html, f"html_title:{file}"),
                require("demo-ready AI data and safety workflow" in html, f"html_description:{file}"),
    ...
    checks.extend(
        [
            ...
            require("docs/interview_walkthrough.md" in sitemap, "sitemap_demo_walkthrough_url"),
            ...
            require("docs/release_notes_v0.3.0.md" in sitemap, "sitemap_release_notes_v0_3_0_url"),
        ]
    )
    ...
    checks.extend(
        [
            ...
            require("../docs/interview_walkthrough.md" in demo_html, "demo_walkthrough_link"),
            ...
            require("../docs/release_notes_v0.3.0.md" in demo_html, "demo_release_notes_link"),
            ...
            require("Demo Walkthrough" in demo_html, "demo_walkthrough_label"),
            ...
            require('id="recommended-actions"' in demo_html, "demo_recommended_actions_mount"),
            require('id="production-roadmap"' in demo_html, "demo_production_roadmap_mount"),
    ...
    checks.extend(
        [
            ...
            require("function renderRecommendedActions()" in demo_app, "demo_app_renders_recommended_actions"),
            require("function renderProductionRoadmap()" in demo_app, "demo_app_renders_production_roadmap"),
            require("function buildCachedEvalResult(reason)" in demo_app, "demo_app_builds_cached_fallback"),
            require("Cached demo result" in demo_app, "demo_app_marks_cached_result"),
            require("productionRoadmap" in demo_app, "demo_app_has_production_roadmap_data"),
